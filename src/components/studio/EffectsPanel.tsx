...
import { CloudRain, Snowflake, CloudFog, Sun, Sparkles, Film, Wind, Grid3x3, Flame, Cloud, Zap } from "lucide-react";
...
const EFFECT_META: Array<{
  ...
  { id: "smoke", name: "Humo", icon: <Cloud className="h-3.5 w-3.5" />, desc: "Humo con física real", canvas: true },
  { id: "fire", name: "Fuego", icon: <Flame className="h-3.5 w-3.5" />, desc: "Llamas con turbulencia", canvas: true },
  { id: "embers", name: "Brasas", icon: <Zap className="h-3.5 w-3.5" />, desc: "Chispas que flotan", canvas: true },
];
  ...
  return (
    <section className="glass rounded-xl p-3">
      ...
      <div className="grid grid-cols-2 gap-1.5">
        {EFFECT_META.filter((e) => !e.canvas).map((e) => {
